...
\address{Department of Physics\enskip\textbullet\enskip Princeton University}{Jadwin Hall, Washington Road\enskip\textbullet\enskip Princeton, New Jersey 08544}
\phone{609-258-8141}
\email{hschrein@cern.ch}
\homepage{iscinumpy.dev}
...
\begin{tabularx}{\textwidth}{p{1.1in}>{\raggedright\arraybackslash}X>{\bfseries}r}
...
\begin{tabularx}{\textwidth}{p{1.1in}>{\raggedright\arraybackslash}X>{\bfseries}r}
    4/2026-- & Computational Physicist/Research Software Engineer, Department of Physics & Princeton University \\
    3/2019--3/2026 & Computational Physicist/Research Software Engineer, Research Computing & Princeton University \\
...
\mysection{Classes and workshops taught}
\begin{tabularx}{\textwidth}{p{.8in}>{\raggedright\arraybackslash}X>{\bfseries}r}
    July 2026 & SIMPLE-Py: \textit{Modern Packaging for Language Extensions in Python}---two-day workshop, organizer & SciPy 2026 \\
    Fall 2025 & APC 524/MAE 506/AST 506: \textit{Software Engineering for Scientific Computing} & Princeton University \\
...
\mysection{Grants}
\begin{tabularx}{\textwidth}{p{.8in}>{\raggedright\arraybackslash}X>{\bfseries}r}
    2022--2026 & Elements: Simplifying Compiled Python Packaging in the Sciences (PI) & \href{https://nsf.gov/awardsearch/showAward?AWD_ID=2209877}{NSF \#2209877} \\
...
\textbf{Article} \emph{Vector: JIT-compilable mathematical manipulations of ragged Lorentz vectors} J. Open Source Softw. \textbf{10}(109), 7791
\end{minipage}
...
\textbf{SciPy 2022} \emph{Awkward Packaging: building Scikit-HEP} Proceedings of the 21st Python in Science Conference, 115--120
\end{minipage}
...
\begin{tabularx}{\textwidth}{p{.5in}>{\raggedright\arraybackslash}X>{\bfseries}r}
2026 & Building an AI-native Research Ecosystem for Experimental Particle Physics: A Community Vision & \href{https://arxiv.org/abs/2602.17582}{arXiv:2602.17582} \\
...
\begin{tabularx}{\textwidth}{>{\bfseries}p{1.1in}>{\raggedright\arraybackslash}X}
Languages & Python \textbullet\ C++ \textbullet\ Rust \textbullet\ Ruby \textbullet\ C \textbullet\ CUDA \textbullet\ Matlab \textbullet\ Lua \textbullet\ JavaScript \textbullet\ TypeScript
\end{tabularx}
...
\textbf{2026:}
Organized and ran SIMPLE-Py, a two-day packaging workshop held with SciPy 2026, under the NSF Elements award. \textbullet\
Released scikit-build-core 1.0 and related releases across the scikit-build family. \textbullet\
PyTorch moved to scikit-build-core. \textbullet\
Made packaging, the library behind almost all Python packaging tools, 3x faster at reading versions and specifiers \textbullet\
Released repo-review 1.0, with a rewritten WebApp \textbullet\
Released cibuildwheel 4.0, boost-histogram 1.7, and Hist 2.10 \textbullet\
Developed a helper tool for adopting PEP 810 lazy imports.


\textbf{2025:}
Developed pybind11 3.0 and cibuildwheel 3.0 packages \textbullet\
Developed a new nox version with many long-requested features. \textbullet\
Joined the pypa/packaging project. \textbullet\
Released UHI 1.0, adding a histogram serialization spec \textbullet\
Completed the 2025 Advent of Code in TypeScript.
...
\begin{tabularx}{\textwidth}{>{\bfseries}p{1.2in}>{\raggedright\arraybackslash}Xr}
    pypa/packaging & The core packaging utilities for Python (2B dpm) & Maintainer \\
    pypa/build & The build tool for Python packages (145M dpm) & Maintainer \\
    pipx & Python application installer (6.6M dpm) & Maintainer \\
    cibuildwheel & Builds binary wheels on CI systems & Maintainer \\
    pyproject-metadata & Tool for PEP 621 backends (13M dpm) & Maintainer \\
    validate-pyproject & Validates Python configuration files & Maintainer \\
    dependency-groups & Tool for PEP 735 dependency groups & Maintainer \\
    pybind11 & The popular C++11 Python bindings (27M dpm) & Maintainer \\
    Nox & Task automation tool (5.8M dpm) & Maintainer \\
    Scikit-build & KitWare's CMake adaptor for Python & Admin \\
    Scikit-build-core & Modern CMake build system for Python (10M dpm) & Primary author \\
    meson-python & The meson adaptor for Python & Maintainer \\
    CMake & KitWare's Python packaging for CMake (17M dpm) & Maintainer \\
    Ninja & KitWare's Python packaging for Ninja (29M dpm) & Maintainer \\
    ...
    Awkward Array & Scikit-HEP package for ragged arrays (1.2M dpm) & Maintainer \\
    Vector & Scikit-HEP package for vectors and Lorentz vectors & Maintainer \\
    Plumbum & Python shell pipelining, CLI, color, and SSH tools (5.8M dpm) & Maintainer \\
    ...
    GooFit & A C++ GPU \& OpenMP fitting library with Python bindings & Maintainer \\
    ROOT & High energy physics C++ toolkit & conda-forge and homebrew \\
    Numba & Provides Numba on Conda & conda-forge maintainer \\
%   trampolim & Modern pure Python package system & Maintainer \\
...
\begin{tabularx}{\textwidth}{>{\bfseries}p{1.4in}>{\raggedright\arraybackslash}X}
...
\begin{tabularx}{\textwidth}{>{\bfseries}p{1.6in}>{\raggedright\arraybackslash}X}
...
\begin{tabularx}{\textwidth}{>{\bfseries}p{1.45in}>{\raggedright\arraybackslash}Xr}
...
ISciNumPy & My blog over programming & \url{iscinumpy.dev} \\
IRIS-HEP & Home of the IRIS-HEP project & \url{iris-hep.org} \\
Scikit-build & Home of the scikit-build projects and events & \url{scikit-build.org} \\
...
\begin{taggedblock}{details}
\begin{tabularx}{\textwidth}{>{\bfseries}p{1.45in}>{\raggedright\arraybackslash}Xr}
UCHenry & An old site for UC and LHCb specific activities & \url{cern.ch/hschrein}  \\
...
\begin{tabularx}{\textwidth}{p{.33in}>{\raggedright\arraybackslash}X>{\bfseries}r}
    2026 & Tools plenaries: scikit-build and cibuildwheel & SciPy 2026 \\
    2026 & AI tools in OSS development & Princeton RSE group \\
    2026 & Tools that help you write better code & Princeton SE Summer School \\
    2026 & Tools to help you write better code & PRC Winter Workshop \\
    2025 & What's new in Python $\pi$ & Princeton RSE group \\
    2025 & Python Histograms & Princeton RSE group \\
    2025 & Using Venvs & HSF-India \\
    2025 & Packaging a Scientific Python Project & SciPy 2025 \\
    2025 & Simplifying compiled Python packaging in the sciences (poster) & US-RSE 2025 \\
    2025 & Building Python Packages & Princeton RSE group \\
    ...
    2023 & Projects report & Princeton RSE Peer Network \\
    ...
    2022 & Building a Binary Extension & PyCon 22 \\
    2022 & Extensionlib proposal & PyCon 22 (packaging summit) \\
    2022 & Guidelines for modern packaging (lightning talk) & PyCon 22 \\
