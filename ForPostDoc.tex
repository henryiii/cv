...
\begin{tabularx}{\textwidth}{>{\bfseries}p{1.2in}Xr}
    ...
    pipx & Python application installer (6.6M dpm) & Co-maintainer \\
    cibuildwheel & Builds binary wheels on CI systems & Co-maintainer \\
    pyproject-metadata & Tool for PEP 621 backends (13M dpm) & Co-maintainer \\
    ...
    Nox & Task automation tool (5.8M dpm) & Co-maintainer \\
    Scikit-build & KitWare's CMake adaptor for Python & Admin \\
    Scikit-build-core & Modern CMake build system for Python (10M dpm) & Author \\
    ...
    Awkward Array & Scikit-HEP package for ragged arrays (1.2M dpm) & Co-maintainer \\
    Vector & Scikit-HEP package for vectors and Lorentz vectors & Co-maintainer \\
