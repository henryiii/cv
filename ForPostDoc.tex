...
\begin{tabularx}{\textwidth}{p{.8in}X>{\bfseries}r}
2024 & Scikit-build-core: A modern build-backend for CPython C/C++/Fortran/Cython extensions & SciPy 2024 (in review) \\
...
\begin{tabularx}{\textwidth}{p{.33in}X>{\bfseries}r}
    2024 & The two flabors of Python 3.13 & PyHEP 2024 \\
